...
public class RepairController {
	...
	public ModelAndView allOngoingRepair() throws Exception {
		context.setAttribute("path", path);
		ModelAndView mav = new ModelAndView("pages/repair/ongoingrepairs");
	...
	@RequestMapping("/all_repairs")
	public ModelAndView allRepairs() throws Exception {
		context.setAttribute("path", path);
		ModelAndView mav = new ModelAndView("pages/repair/allrepairs");
	...
	@ResponseBody
	public Map allsentRepairDetails() throws Exception {
	...
	@RequestMapping("/all_ongoing_repair_dt")
	@ResponseBody
	public Map allOngoingRepairs() throws Exception {

		List entities = new ArrayList();

		List<RepairSentDto> repairSentDtos = repairService.getOngoingRepairs();
		...
		for (RepairSentDto repairSentDto : repairSentDtos) {
			...
			if (repairSentDto.getStatus().equals(AppConstant.SEND) || repairSentDto.getStatus().equals(AppConstant.RETURN)) {
	...
	@RequestMapping("/all_repair_dt")
	@ResponseBody
	public Map allRepairsDt() throws Exception {

		List entities = new ArrayList();

		List<RepairSentDto> repairSentDtos = repairService.getAllRepairs();
	...
	@ResponseBody
	public String addBasicDetailsRepair(@RequestBody RepairBasicsDto repairBasicsDto, @PathVariable String repairId)
			throws Exception {
