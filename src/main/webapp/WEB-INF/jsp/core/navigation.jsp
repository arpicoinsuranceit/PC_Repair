	...
	<body>
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
		        ...
		        <c:forEach var="menu" items="user.menuDtos">
		        
		        	<% System.out.println("sdsd"); %>
		        
		        	<%-- <c:if test="${menu.menuName eq 'Repairs'}">
		        	
		        		<li class="treeview"><a href="${menu.href}"><i class="fa fa-wrench"></i>
							<span>${menu.menuDescription}</span> <span class="pull-right-container"> <i
					...
					<li class="treeview"><a href="#"><i class="fa fa-wrench"></i>
							<span>Repairs</span> <span class="pull-right-container"> <i
								class="fa fa-angle-left pull-right"></i>
						</span> </a>
					...
					<li class="treeview"><a href="#"><i class="fa fa-desktop"></i>
							<span>Assets</span> <span class="pull-right-container"> <i
								class="fa fa-angle-left pull-right"></i>
						</span> </a>
						<ul class="treeview-menu">
					...
					<li class="treeview"><a href="#"><i
							class="fa fa-shopping-bag"></i> <span>Parts</span> <span
					...
					<li class="treeview"><a href="#"><i class="fa fa-hdd-o"></i>
							<span>Backups</span> <span class="pull-right-container"> <i
								class="fa fa-angle-left pull-right"></i>
						</span> </a>
						<ul class="treeview-menu">
							<li><a href="${path}/all_supplier"><i class="fa fa-circle-thin"></i>
					...
					<li class="treeview"><a href="#"><i class="fa fa-link"></i>
							<span>Supplier</span> <span class="pull-right-container"> <i
								class="fa fa-angle-left pull-right"></i>
						</span> </a>
						<ul class="treeview-menu">
							<li><a href="${path}/all_supplier"><i class="fa fa-circle-thin"></i>
					...
					<li class="treeview"><a href="#"><i class="fa fa-user"></i>
							<span>Assignee</span> <span class="pull-right-container"> <i
								class="fa fa-angle-left pull-right"></i>
						</span> </a>
						<ul class="treeview-menu">
					...
					<li class="treeview"><a href="#"><i
							class="fa fa-exclamation-circle"></i> <span>Errors</span> <span
							class="pull-right-container"> <i
								class="fa fa-angle-left pull-right"></i>
						</span> </a>
						<ul class="treeview-menu">
