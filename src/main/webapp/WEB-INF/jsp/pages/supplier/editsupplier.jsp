                ...
                <div class="box-body">
                    <form id="form_edit_supplier">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="supplierId" value="${sup_id}" placeholder="Enter Supplier Id"  readonly>
                        </div>

                        <div class="form-group">
                            <label>Supplier Name</label>
                            <input type="text" class="form-control" name="supplierName" value="${sup_name}" placeholder="Enter Supplier Name">
                        </div>

                        <div class="box-footer">
                            <button type="button" class="btn btn-default">Cancel</button>
                            <button type="button" id="button-editsupplier" class="btn btn-info pull-right">Edit Supplier
                            </button>
                        </div>
                    </form>
                </div>
