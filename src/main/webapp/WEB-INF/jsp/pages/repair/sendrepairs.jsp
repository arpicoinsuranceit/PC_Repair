...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                REPAIR
                <small>SEND REPAIRS</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="/all_supplier"><i class="fa fa-dashboard"></i>REPAIR</a></li>
                <li class="active">SEND REPAIRS</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">Send Repairs</h3>
                        </div>
                        <div class="box-body">

                            <table id="table_send_repair" class="table table-bordered">
                                <thead>
                                <tr>
                                    <th>Repair Id</th>
                                    <th>Asset</th>
